...
root.title("Taj Hotel")

def getvals():
    f1=open("tajreport.txt",'a')
    f1.write(f"Name:{nameValue.get()} \n Phone:{phoneValue.get()} \n Gender:{genderValue.get()} \n Emergency Contact No:{emergencyValue.get()} \n Payment Mode: {paymentValue.get()} \n Food: {foodserviceValue.get()} \n \n \n")

# Heading
Label(root, text="Welcome to Taj Hotel",font="cambria 15 bold",pady=15).grid(row=0, column=3)
# text for our form
